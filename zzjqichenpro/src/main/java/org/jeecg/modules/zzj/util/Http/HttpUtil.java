...
public class HttpUtil {
     ...
     */
    public static String sendGet(String url, String param,Map<String,String> paramMap,String nowDate) {
        String result = "";
        ...
        try {
            ...
            //urlNameString += "?"+ URLEncoder.encode(param, "utf8") ;
            urlNameString += "?"+ param;
            ...
            String header= paramMap.get("TicketID")+"|"+paramMap.get("Sign")+"|"+nowDate;
            System.out.println("header:"+header);
            connection.setRequestProperty("X-AUTH-HEADER",header);
            // 建立实际的连接
            connection.connect();
            // 获取所有响应头字段
     ...
     * @return 所代表远程资源的响应结果
     */
    public static String sendPost(String url, String param,Map<String,String> map,String nowDate) {
        ...
        try {
            ...
            conn.setRequestProperty("user-agent",
                    "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1;SV1)");
            String header= map.get("TicketID")+"|"+map.get("Sign")+"|"+nowDate;
            System.out.println("header:"+header);
            conn.setRequestProperty("X-AUTH-HEADER",header);
            // 发送POST请求必须设置如下两行
